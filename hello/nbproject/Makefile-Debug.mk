...
${TESTDIR}/tests/TestRunner.o: tests/TestRunner.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestRunner.o tests/TestRunner.cpp


${TESTDIR}/gtest/src/gtest-all.o: gtest/src/gtest-all.cc 
	${MKDIR} -p ${TESTDIR}/gtest/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Igtest -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/gtest/src/gtest-all.o gtest/src/gtest-all.cc

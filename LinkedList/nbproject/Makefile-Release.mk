...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/liblinkedlist.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/liblinkedlist.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/liblinkedlist.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/liblinkedlist.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/liblinkedlist.a
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/TestRunner.o ${TESTDIR}/gtest/src/gtest-all.o ${OBJECTFILES:%.o=%_nomain.o}
